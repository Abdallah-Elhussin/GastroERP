...
public record GetAccountTreeQuery(Guid TenantId) : IRequest<Result<IReadOnlyList<AccountTreeNodeDto>>>;
...
public record GetFiscalPeriodsQuery(Guid TenantId) : IRequest<Result<IReadOnlyList<FiscalPeriodDto>>>;
...
public record GetGeneralLedgerQuery(GeneralLedgerFilterDto Filter) : IRequest<Result<IReadOnlyList<GeneralLedgerLineDto>>>;
