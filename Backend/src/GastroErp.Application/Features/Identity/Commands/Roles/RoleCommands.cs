...
public record CopyRoleCommand(Guid SourceRoleId, string? Name = null, string? NameAr = null) : IRequest<Result<Guid>>;
...
public record ReplaceRolePermissionsCommand(Guid Id, List<Guid> PermissionIds) : IRequest<Result>;
