...
{
    /// <inheritdoc />
    public partial class AddHrWorkforceModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmploymentHistoryEntries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterviewRecords", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedDeductions = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeContracts_TenantId_EmployeeId_IsActive",
                table: "EmployeeContracts",
                columns: new[] { "TenantId", "EmployeeId", "IsActive" },
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeePositions_TenantId_CompanyId_Name",
                table: "EmployeePositions",
                columns: new[] { "TenantId", "CompanyId", "Name" },
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_Employees_TenantId_CompanyId_Status",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTrainingRecords_TenantId_EmployeeId_CourseId",
                table: "EmployeeTrainingRecords",
                columns: new[] { "TenantId", "EmployeeId", "CourseId" },
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_Holidays_TenantId_CompanyId_Date",
                table: "Holidays",
                columns: new[] { "TenantId", "CompanyId", "Date" },
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveBalances_TenantId_EmployeeId_LeaveType_Year",
                table: "LeaveBalances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollPayslips_PayrollRunId_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollRuns_TenantId_CompanyId_Year_Month",
                table: "PayrollRuns",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryStructures_TenantId_EmployeeId_IsActive",
                table: "SalaryStructures",
                columns: new[] { "TenantId", "EmployeeId", "IsActive" },
                filter: "[IsDeleted] = 0 AND [IsActive] = 1");

            migrationBuilder.CreateIndex(
                name: "IX_WorkingShifts_TenantId_BranchId_Name",
                table: "WorkingShifts",
                columns: new[] { "TenantId", "BranchId", "Name" },
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_WorkScheduleEntries_TenantId_EmployeeId_ScheduleDate",
