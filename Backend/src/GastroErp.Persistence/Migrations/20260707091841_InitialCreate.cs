    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BranchDevices", x => new { x.BranchId, x.DeviceId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_StreetAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Address_StreetEn = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Address_CityAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Address_CityEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Address_RegionAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Address_RegionEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Address_PostalCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Address_CountryAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Address_CountryEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    AllowOfflineSales = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ComboMeals_Dates", "[EndDate] IS NULL OR [EndDate] >= [StartDate]");
                    table.CheckConstraint("CK_ComboMeals_Price", "[ComboPrice] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultPurchaseUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DefaultRecipeUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostingMethod = table.Column<byte>(type: "tinyint", nullable: false),
                    AllowNegativeInventory = table.Column<bool>(type: "bit", nullable: false),
                    AutoReserveStock = table.Column<bool>(type: "bit", nullable: false),
                    AutoIssueRecipe = table.Column<bool>(type: "bit", nullable: false),
                    RequireBatchTracking = table.Column<bool>(type: "bit", nullable: false),
                    RequireExpiryTracking = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceDocumentNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SymbolAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    CaloriesMin = table.Column<int>(type: "int", nullable: true),
                    CaloriesMax = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Yield = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Branding_LogoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WasteDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsCompleted = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BranchMenuId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuAvailabilities_BranchMenus_BranchMenuId",
                        column: x => x.BranchMenuId,
                        principalTable: "BranchMenus",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ComboMealId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    AllowSubstitution = table.Column<bool>(type: "bit", nullable: false),
                    SubstitutionCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SortOrder = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComboItems", x => x.Id);
                    table.CheckConstraint("CK_ComboItems_Quantity", "[Quantity] >= 1");
                    table.ForeignKey(
                        name: "FK_ComboItems_ComboMeals_ComboMealId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InventoryItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WarehouseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WarehouseBinId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockMovements_InventoryTransactions_InventoryTransactionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ModifierGroups_Selection", "[MaxSelection] >= [MinSelection] AND [MaxSelection] >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPriceLevels", x => new { x.ProductId, x.PriceLevelId });
                    table.CheckConstraint("CK_ProductPriceLevels_Price", "[Price] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InventoryItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AdjustmentReasonId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WasteRecordId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InventoryItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WasteReasonId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    UnitCost = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    BatchNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaloriesExtra = table.Column<int>(type: "int", nullable: true),
                    IsDefault = table.Column<bool>(type: "bit", nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Modifiers_ExtraPrice", "[ExtraPrice] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WarehouseShelves_WarehouseZones_WarehouseZoneId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WarehouseShelfId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NameAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    NameEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WarehouseBins_WarehouseShelves_WarehouseShelfId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdjustmentReasons_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchDevices_TenantId",
                table: "BranchDevices",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchMenus_BranchId_MenuId",
                table: "BranchMenus",
                columns: new[] { "BranchId", "MenuId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_TenantId_SortOrder",
                table: "Categories",
                columns: new[] { "TenantId", "SortOrder" },
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_ComboItems_ComboMealId",
                table: "ComboItems",
                column: "ComboMealId");

            migrationBuilder.CreateIndex(
                name: "IX_ComboMeals_TenantId",
                table: "ComboMeals",
                column: "TenantId",
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_ActivationCode",
                table: "Devices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventorySettings_TenantId_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryUnits_TenantId",
                table: "InventoryUnits",
                column: "TenantId",
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_MenuAvailabilities_BranchMenuId_DayOfWeek",
                table: "MenuAvailabilities",
                columns: new[] { "BranchMenuId", "DayOfWeek" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_MenuSectionId_ProductId",
                table: "MenuItems",
                columns: new[] { "MenuSectionId", "ProductId" },
                unique: true,
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_InventoryTransactionId",
                table: "StockMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBranches_AppUserId",
                table: "UserBranches",
                column: "AppUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseBins_WarehouseShelfId",
                table: "WarehouseBins",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseShelves_WarehouseZoneId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WasteReasons_TenantId",
                table: "WasteReasons",
                column: "TenantId",
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_WasteRecords_TenantId",
                table: "WasteRecords",
                column: "TenantId",
                filter: "[IsDeleted] = 0");
        }
